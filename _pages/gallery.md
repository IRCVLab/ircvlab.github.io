...
<div markdown="0" class="gallery-event">
  <div class="row">
    ...
    <div class="col-sm-4">
      <a href="{{ site.url }}{{ site.baseurl }}/gallery/picnic2026" class="gallery-card">
        <div class="gallery-thumb" style="background-image:url('{{ site.url }}{{ site.baseurl }}/images/gallery/picnic2026/1.jpg');"></div>
        <div class="gallery-meta">
            <h4 class="gallery-title">2026 Spring Picnic</h4>
            <span class="gallery-cta">Open album →</span>
        </div>
      </a>
    </div>
